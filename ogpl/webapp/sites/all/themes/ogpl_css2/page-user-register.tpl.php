	...
	<div id="block-blockify-blockify-logo" class="block block-blockify odd first last grid16-3 logo-block">
  	<div class="inner clearfix">
            <div class="content clearfix">
      		<a href="<?php echo $base_url; ?>" id="logo" rel="home" title="Return to the OpenGov Platform DMS home page" class="active"><img src="<?php echo $base_url.'/'.drupal_get_path('theme', 'dms');?>/logo.png" alt="OpenGov Platform DMS logo" title="" width="150" height="124" /></a>    </div>
  		</div><!-- /block-inner -->
	</div><!-- /block -->
